// AlefAppWizardaw.cpp : implementation file
//
...
void CAlefAppWizardAppWiz::InitCustomAppWiz()
{
...
void CAlefAppWizardAppWiz::ExitCustomAppWiz()
{
	...
	m_Dictionary.Lookup(_T("FULL_DIR_PATH"), strPath);
	m_Dictionary.Lookup(_T("root"), strRoot);

	strDummy = strPath + "dummy.h";
	strPath += strRoot + ".dsp";

	CopyFile( strDummy, strPath, FALSE );
	DeleteFile( strDummy );
}

// This is called when the user clicks "Create..." on the New Project dialog
CAppWizStepDlg* CAlefAppWizardAppWiz::Next(CAppWizStepDlg* pDlg)
{
...
void CAlefAppWizardAppWiz::CustomizeProject(IBuildProject* pProject)
{
...
// Here we define one instance of the CAlefAppWizardAppWiz class.  You can access
//  m_Dictionary and any other public members of this class through the
//  global AlefAppWizardaw.
CAlefAppWizardAppWiz AlefAppWizardaw;
