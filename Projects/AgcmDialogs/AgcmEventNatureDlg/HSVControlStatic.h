...
protected:
	...
	void	ALPHA_DrawSelectBox	( CDC * pDC , CRect &rect	);
	void	ALPHA_LButtonDown	( UINT nFlags, CPoint point	);
	void	ALPHA_LButtonUp		( UINT nFlags, CPoint point	);
	void	ALPHA_MouseMove		( UINT nFlags, CPoint point	);
	...
	BOOL	m_bPreviewPress		;
	int		m_nRBackup			;	// 0~255
	int		m_nGBackup			;	// 0~255
	int		m_nBBackup			;	// 0~255
