...
CString CObjectDlg::s_strCategory;
	...
	: CDialog(CObjectDlg::IDD, pParent)
{
	...
	if( strlen(pcsAgcdObjectTemplate->m_szCategory) )
		s_strCategory			= _T(pcsAgcdObjectTemplate->m_szCategory);
...
void CObjectDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_CATEGORY, s_strCategory);
...
void CObjectDlg::OnOK()
{
	...
	strcpy(m_pcsAgcdObjectTemplate->m_szCategory, s_strCategory);
