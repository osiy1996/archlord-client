...
struct RpPrtStdEmitterStandard
{
    ...
    RwV2d                       prtSize;                        /**< Particle's size. This is ignored if each
                                                                 * particle has its own size. */

    RwRGBA                      prtColor;                       /**< Particle's color. This is ignored if each
                                                                 * particle has its own colors. */

    RwReal                      prtDelta2DRotate;               /**< Particle's 2D rotation in radians.
                                                                 * This is ignored if each particle has its own
                                                                 * rotation. */
...
typedef struct RpPrtStdEmitterPrt2DRotate RpPrtStdEmitterPrt2DRotate;
...
struct RpPrtStdEmitterPrt2DRotate
{
    RwReal                      prtStart2DRotate,                       /**< Particle start 2D rotate */
                                prtStart2DRotateBias;                   /**< Particle start 2D rotate bias */
    RwReal                      prtEnd2DRotate,                         /**< Particle end 2D rotate */
...
struct RpPrtStdEmitterPTank
{
    RwUInt32                    dataFlags,      /**< Data flag used in RpPTank creation. See
                                ...
                                emitFlags;      /**< A flag representing the properties to be initialized
                                                 * by the particle emitter during particles emission. A user
                                                 * may select to initialize some properties manually by
                                                 * unsetting the relevant bits in the flag.
                                                 * The flag settings are the same as \ref RpPTankDataFlags */
    RpAtomic                    *pTank;         /**< Pointer to the RpPTank \ref RpAtomic. */
    RwChar                      **dataInPtrs,   /**< An array of pointers pointing to the particle's property
                                                 * buffers in RpPTank. This array points to the input values to
                                                 * be updated. The pointers must be incremented after each
                                ...
                                **dataOutPtrs;  /**< An array of pointers pointing to the particle's property
                                                 ...
                                                 * properties. The order of the properties is constant.
                                                 * \see RpPTankDataLockFlags. */
    RwInt32                     *dataStride;    /**< An array of \ref RwInt32 to store the stride of the
                                                 ...
                                                 * \see RpPTankDataLockFlags. */
    RwUInt32                    strSrcBlend;    /**< This is used to set the source blend mode for the RpPTank
    ...
    RwUInt32                    strDstBlend;    /**< This is used to set the destination blend mode for the RpPTank
                                                 * \ref RpAtomic when it is created for the first time.
                                                 * \see RpPTankAtomicSetBlendModes. */
    RwBool                      strVtxABlend;   /**< This is used to enable vertex alpha blending for the
...
#define rpPRTSTDPROPERTYCODEPARTICLE2DROTATE                4
...
#define rpPRTSTDPARTICLEDATAFLAG2DROTATE                    0x00000010
...
typedef struct RpPrtStdParticle2DRotate RpPrtStdParticle2DRotate;
...
struct RpPrtStdParticle2DRotate
{
    RwReal                      start2DRotate,                      /**< Particle's starting 2D rotation */
...
/*---- start: c:/RW/Graphics/rwsdk/plugin/prtstd/d3d9/prtstdplatform.h----*/
/*---- end: c:/RW/Graphics/rwsdk/plugin/prtstd/d3d9/prtstdplatform.h----*/
