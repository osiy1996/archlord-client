...
//===========================================================================
class _XTP_EXT_CLASS CXTResizeDialog : public CDialog, public CXTResize
{
...
public:
	...
	//-----------------------------------------------------------------------
	CXTResizeDialog();
	CXTResizeDialog(const UINT nID, CWnd* pParent = 0, const UINT nFlags = 0); // <combine CXTResizeDialog::CXTResizeDialog>
	CXTResizeDialog(LPCTSTR lpszTemplateName, CWnd* pParent = 0, const UINT nFlags = 0); // <combine CXTResizeDialog::CXTResizeDialog>
