...
//     to the tab control.
//===========================================================================
class _XTP_EXT_CLASS CXTMDIClientWnd : public CWnd
{
public:
	//-----------------------------------------------------------------------
	// Summary:
...
DECLATE_TABCTRL_BASE(CXTMDIWndTabBase, CTabCtrl, CXTTabBase)
...
//     (MDI) application.
// Example:
//     The following example demonstrates the use of CXTMDIWndTab.
// <code>
...
// </code>
// -------------------------------------------------------------------
class _XTP_EXT_CLASS CXTMDIWndTab : public CXTMDIWndTabBase
{
	DECLARE_DYNAMIC(CXTMDIWndTab)
	DECLARE_THEME_REFRESH(CXTMDIWndTab)
...
public:
	...
	bool SetTabIcon(HWND hChildWnd, HICON& hIcon); // <combine CXTMDIWndTab::SetTabIcon@int@HICON&>
	...
	bool SetTabLabel(HWND hChildWnd, CString& strLabel); // <combine CXTMDIWndTab::SetTabLabel@int@CString&>
	...
	CMDIChildWnd* GetFrameWnd(CPoint point) const; // <combine CXTMDIWndTab::GetFrameWnd@int@const>
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called by the CXTMDIWndTab class to
