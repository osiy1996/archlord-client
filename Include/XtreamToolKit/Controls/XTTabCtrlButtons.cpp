...
void CXTTabCtrlButtons::OnPaint()
{
	...
	COLORREF clrText =m_pTabCtrlBase->GetPaintManager()->FillButtons(&dc, this);
...
BOOL CXTTabCtrlButtons::Create(CXTTabBase* pCtrlBase)
{
...
void CXTTabCtrlButtons::UnSubclassTabButtons()
{
	if (m_hWnd)
	{
