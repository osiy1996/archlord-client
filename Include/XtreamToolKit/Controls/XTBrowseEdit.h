...
// --------------------------------------------------------------------
class _XTP_EXT_CLASS CXTBrowseButton : public CXTButton
{
...
// --------------------------------------------------------------------
class _XTP_EXT_CLASS CXTBrowseEdit : public CXTEdit
{
...
AFX_INLINE void CXTBrowseEdit::SetDlgInitialDir(LPCTSTR lpszInitialDir) {
...
// Note: this must match the LBS_XT_BROWSE define
const DWORD BES_XT_BROWSE          = 0x0010; // Display a user defined dialog for browsing
...
//===========================================================================
class _XTP_EXT_CLASS CXTItemEdit : public CXTBrowseEdit
{
