...
//===========================================================================
class _XTP_EXT_CLASS CXTRegistryManager
{
private:
	class CHKey;
...
AFX_INLINE void CXTRegistryManager::SetINIFileName(LPCTSTR strINIFileName) {
	m_strINIFileName = strINIFileName;
}
AFX_INLINE CString& CXTRegistryManager::GetINIFileName() {
	return m_strINIFileName;
}
AFX_INLINE LONG CXTRegistryManager::GetErrorCode() const {
	return m_lResult;
}
