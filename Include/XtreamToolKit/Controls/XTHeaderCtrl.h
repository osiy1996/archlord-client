// XTHeaderCtrl.h interface for the CXTFlatHeaderCtrl class.
//
...
//========================================================================
class _XTP_EXT_CLASS CXTHeaderCtrl : public CXTHeaderCtrlHelper, public CXTThemeManagerStyleHostBase
{
	DECLARE_DYNAMIC(CXTHeaderCtrl)
	DECLARE_THEME_HOST(CXTHeaderCtrl)
	DECLARE_THEME_REFRESH(CXTHeaderCtrl)
...
protected:
	...
	friend class CXTHeaderCtrlTheme;
};
...
//     controls seen in Visual Studio(tm) and Outlook(tm).
//========================================================================
class _XTP_EXT_CLASS CXTFlatHeaderCtrl : public CXTHeaderCtrl
{
