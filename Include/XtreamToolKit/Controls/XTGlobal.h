...
// ----------------------------------------------------------------------
// Summary:
//     CXTTcbItem class is used to maintain information for a
//     particular tab item in a CXTExcelTabCtrl, CXTTabCtrl and CXTTabView object.
// See Also:
//     CXTExcelTabCtrl, CXTTabCtrl and CXTTabView
// ----------------------------------------------------------------------
class _XTP_EXT_CLASS CXTTcbItem
{
public:
	//-------------------------------------------------------------------------
	// Summary:
	//     Constructs an CXTTcbItem object
	//-------------------------------------------------------------------------
	CXTTcbItem();
...
//{{AFX_CODEJOCK_PRIVATE
#define XT_TCB_ITEM CXTTcbItem // deprecated
//}}AFX_CODEJOCK_PRIVATE
...
// </code>
//=============================================================================
class _XTP_EXT_CLASS CXTNonClientMetrics : public NONCLIENTMETRICS
{
public:
	//-------------------------------------------------------------------------
	// Summary:
...
// --------------------------------------------------------------------
class _XTP_EXT_CLASS CXTAuxDataTheme
{
public:
	// ---------------------------------------------------------------------
	// Summary:
...
//=============================================================================
class _XTP_EXT_CLASS CXTLogFont : public LOGFONT
{
public:
	//-------------------------------------------------------------------------
	// Summary:
...
//     CXTAuxData class.
// Remarks:
//     Call this function to access CXTAuxData members. Since
...
// Example:
//     The following example demonstrates the use of XTAuxData.
// <code>
...
// ---------------------------------------------------------------------
class _XTP_EXT_CLASS CXTAuxData
{
private:
	// ------------------------------------------
	// Summary:
...
private:
	...
	DISABLE_COPY_OPERATOR(CXTAuxData)
...
public:
	...
	friend _XTP_EXT_CLASS CXTAuxData& AFXAPI XTAuxData();
};
