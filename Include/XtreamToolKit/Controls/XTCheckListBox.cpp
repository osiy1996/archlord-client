...
CXTCheckListBox::CCheckListState::CCheckListState(BOOL bListBox3D)
{
	CBitmap bitmap;
	VERIFY(XTPResourceManager()->LoadBitmap(&bitmap, !bListBox3D ? XT_IDB_CHECKLISTBOX : XT_IDB_CHECKLISTBOX_3D));
...
CXTCheckListBox::CXTCheckListBox(BOOL bListBox3D /* = FALSE */)
