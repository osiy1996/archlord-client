...
//===========================================================================
// Summary:
//     CXTTipOfTheDay is a CDialog derived class.
//     CXTTipOfTheDay is used to create a Visual Studio(tm) style
...
//===========================================================================
class _XTP_EXT_CLASS CXTTipOfTheDay : public CDialog
{
...
protected:
	...
	CImageList m_ilLightBulb;   // Bulb bitmap.
