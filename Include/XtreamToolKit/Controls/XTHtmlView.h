...
public:
	...
	void Navigate2(LPCTSTR lpszURL, DWORD dwFlags = 0, LPCTSTR lpszTargetFrameName = NULL, LPCTSTR lpszHeaders = NULL, LPVOID lpvPostData = NULL, DWORD dwPostDataLen = 0); // <combine CXTHtmlView::Navigate2@LPITEMIDLIST@DWORD@LPCTSTR>
	void Navigate2(LPCTSTR lpszURL, DWORD dwFlags, CByteArray& baPostedData, LPCTSTR lpszTargetFrameName = NULL, LPCTSTR lpszHeader = NULL); // <combine CXTHtmlView::Navigate2@LPITEMIDLIST@DWORD@LPCTSTR>
