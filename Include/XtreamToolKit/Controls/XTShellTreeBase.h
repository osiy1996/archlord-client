...
enum XTFindType
{
	...
	xtFindTypeRoot,   // The object type is a root folder
	xtFindTypeShare   // The object is a UNC share
};
...
//===========================================================================
class _XTP_EXT_CLASS CXTShellTreeBase : public CXTTreeBase, public CXTShellPidl
{
public:
...
public:
	...
	//     TRUE if successful, otherwise returns FALSE.
	//-----------------------------------------------------------------------
	virtual BOOL FindTreeItem(HTREEITEM hItem, XT_LVITEMDATA* lplvid, BOOL bRecursively = TRUE);
...
AFX_INLINE void CXTShellTreeBase::SetRootFolder(int nRootFolder /*= CSIDL_DESKTOP*/) {
	m_nRootFolder = nRootFolder;
}
AFX_INLINE void CXTShellTreeBase::ShowFiles(BOOL bShowFiles /*= TRUE*/) {
