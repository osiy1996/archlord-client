...
//     index.
// --------------------------------------------------------------------
class _XTP_EXT_CLASS CXTSplitterWnd : public CSplitterWnd, public CXTThemeManagerStyleHostBase
{
	DECLARE_DYNAMIC(CXTSplitterWnd)
	DECLARE_THEME_HOST(CXTSplitterWnd)
	DECLARE_THEME_REFRESH(CXTSplitterWnd)
...
// ---------------------------------------------------------------------
class _XTP_EXT_CLASS CXTSplitterWndEx : public CXTSplitterWnd
{
