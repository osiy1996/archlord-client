...
bool CXTMemFile::Duplicate(LPCTSTR strDup)
{
...
CFile* CXTMemFile::Duplicate() const
{
	return CMemFile::Duplicate();
}

BOOL CXTMemFile::Open(LPCTSTR lpszFileName, UINT nOpenFlags, CFileException* pError /*= NULL*/)
{
...
DWORD CXTMemFile::Insert(LPCTSTR strSrc, DWORD dwSourcePos, DWORD dwDestPos, DWORD dwBytes)
{
...
DWORD CXTMemFile::Extract(LPCTSTR strDest, DWORD dwStartPos, DWORD dwBytes)
{
