...
public:
	...
	virtual bool Duplicate(LPCTSTR strDup); // <combine CXTMemFile::Duplicate@CFile* >
	...
	virtual DWORD Insert(LPCTSTR strSrc, DWORD dwSourcePos, DWORD dwDestPos, DWORD dwBytes); // <combine CXTMemFile::Insert@CFile*@DWORD@DWORD@DWORD>
	...
	virtual DWORD Extract(LPCTSTR strDest, DWORD dwStartPos, DWORD dwBytes); // <combine CXTMemFile::Extract@CFile*@DWORD@DWORD>
