...
//===========================================================================
class _XTP_EXT_CLASS CXTMenuListBox : public CListBox, public CXTThemeManagerStyleHostBase
{
	DECLARE_DYNAMIC(CXTMenuListBox)
	DECLARE_THEME_HOST(CXTMenuListBox)
	DECLARE_THEME_REFRESH(CXTMenuListBox)
