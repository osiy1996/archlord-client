...
//===========================================================================
class _XTP_EXT_CLASS CXTResizeItem
{
public:
...
//     a sizing window.
//===========================================================================
class _XTP_EXT_CLASS CXTSizeIcon : public CScrollBar
{
public:
	//-----------------------------------------------------------------------
	// Summary:
...
//===========================================================================
class _XTP_EXT_CLASS CXTResize
{
public:
...
protected: // helper methods
	...
	//     pItem    - [in] Pointer to a CXTResizeItem object that contains additional information about the window being sized.
	//     dx       - [in] Specifies the window's new width, in pixels.
	//     dy       - [in] Specifies the window's new height, in pixels.
	// Returns:
	//     TRUE if successful, otherwise FALSE.
	//-----------------------------------------------------------------------
	virtual BOOL Defer(HDWP& hdwp, CXTResizeItem* pItem, int dx, int dy);
