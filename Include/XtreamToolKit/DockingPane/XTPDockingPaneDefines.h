...
enum XTPDockingPanePaintTheme
{
	...
	xtpPaneThemeOffice2007,         // Office 2007 theme
...
//
// <KEYWORDS xtpPaneStickerStyleWhidbey, xtpPaneStickerStyleVisualStudio2005>
//-----------------------------------------------------------------------
enum XTPDockingContextStickerStyle
{
	xtpPaneStickerStyleWhidbey,            // Whidbey stickers
...
enum XTPDockingPaneAction
{
	...
	xtpPaneActionDetaching,  // Docking pane deactivated
...
//-------------------------------------------------------------------------
enum XTPXTPDockingPaneEnableOptions
{
...
const int XTP_DPN_PANEMENUCLICK =  5; //<ALIAS XTPWM_DOCKINGPANE_NOTIFY>
