...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberSin(/*_ OCIError *err, CONST OCINumber *number,
                       OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberArcSin(/*_ OCIError *err, CONST OCINumber *number,
                          OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberHypSin(/*_ OCIError *err, CONST OCINumber *number, 
                          OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberCos(/*_ OCIError *err, CONST OCINumber *number, 
                       OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberArcCos(/*_ OCIError *err, CONST OCINumber *number, 
                          OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberHypCos(/*_ OCIError *err, CONST OCINumber *number, 
                          OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberTan(/*_ OCIError *err, CONST OCINumber *number, 
                       OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberArcTan(/*_ OCIError *err, CONST OCINumber *number, 
                          OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberArcTan2(/*_ OCIError *err, CONST OCINumber *number1, 
                           CONST OCINumber *number2, OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberHypTan(/*_ OCIError *err, CONST OCINumber *number,
                          OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberExp(/*_ OCIError *err, CONST OCINumber *number, 
                       OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberLn(/*_ OCIError *err, CONST OCINumber *number, 
                      OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCINumberLog(/*_ OCIError *err, CONST OCINumber *base, 
                       CONST OCINumber *number, OCINumber *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateAssign(/*_ OCIError *err, CONST OCIDate *from, 
			OCIDate *to _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateToText(/*_ OCIError *err, CONST OCIDate *date, 
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateFromText(/*_ OCIError *err, CONST oratext *date_str, 
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateCompare(/*_ OCIError *err, CONST OCIDate *date1, 
                     CONST OCIDate *date2, sword *result _*/);
#else /* ANSI C */
   ...
   PARAMETERS:
  	...
  	date1, date2 (IN) - dates to be compared
        result (OUT) - comparison result, 0 if equal, -1 if date1 < date2, 
  		1 if date1 > date2
   DESCRIPTION:
  	The function OCIDateCompare compares two dates. It returns -1 if date1 is 
  	smaller than date2, 0 if they are equal, and 1 if date1 is greater 
  	than date2.
   RETURNS:
        OCI_SUCCESS if the function completes successfully.
        OCI_INVALID_HANDLE if 'err' is NULL.
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateAddMonths(/*_ OCIError *err, CONST OCIDate *date, sb4 num_months,
                           OCIDate *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateAddDays(/*_ OCIError *err, CONST OCIDate *date, sb4 num_days,
                         OCIDate *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateLastDay(/*_ OCIError *err, CONST OCIDate *date,    
                         OCIDate *last_day _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateDaysBetween(/*_ OCIError *err, CONST OCIDate *date1, 
                             CONST OCIDate *date2, sb4 *num_days _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateZoneToZone(/*_ OCIError *err, CONST OCIDate *date1,
                            CONST oratext *zon1,
                            ub4 zon1_length, CONST oratext *zon2, ub4 zon2_length,
                            OCIDate *date2 _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateNextDay(/*_ OCIError *err, CONST OCIDate *date, CONST oratext *day_p, 
                         ub4 day_length, OCIDate *next_day _*/);
#else /* ANSI C */
sword OCIDateNextDay(    OCIError *err, CONST OCIDate *date, CONST oratext *day_p, 
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateCheck(/*_ OCIError *err, CONST OCIDate *date, uword *valid _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDateSysDate(/*_ OCIError *err, OCIDate *sys_date _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIStringAssign(/*_ OCIEnv *env, OCIError *err, CONST OCIString *rhs, 
                          OCIString **lhs _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIStringAssignText(/*_ OCIEnv *env, OCIError *err, CONST oratext *rhs, 
                              ub4 rhs_len, OCIString **lhs _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIStringResize(/*_ OCIEnv *env, OCIError *err, ub4 new_size, 
                          OCIString **str _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
ub4 OCIStringSize(/*_ OCIEnv *env, CONST OCIString *vs _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
oratext *OCIStringPtr(/*_ OCIEnv *env, CONST OCIString *vs _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIStringAllocSize(/*_ OCIEnv *env, OCIError *err, CONST OCIString *vs, 
                             ub4 *allocsize _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIRawAssignRaw(/*_ OCIEnv *env, OCIError *err, CONST OCIRaw *rhs, 
                          OCIRaw **lhs _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIRawAssignBytes(/*_ OCIEnv *env, OCIError *err, CONST ub1 *rhs, 
                            ub4 rhs_len, OCIRaw **lhs _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIRawResize(/*_ OCIEnv *env, OCIError *err, ub4 new_size, 
                       OCIRaw **raw _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
ub4 OCIRawSize(/*_ OCIEnv * env, CONST OCIRaw *raw _*/);
#else /* ANSI C */
...
/*--------------------------------- OCIRawPtr -------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
ub1 *OCIRawPtr(/*_ OCIEnv * env, CONST OCIRaw *raw _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIRawAllocSize(/*_ OCIEnv *env, OCIError *err, CONST OCIRaw *raw,
                          ub4 *allocsize _*/);
#else /* ANSI C */
...
/*---------------------------- OCIRefClear ----------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
void OCIRefClear(/*_ OCIEnv *env, OCIRef *ref _*/);
#else /* ANSI C */
...
/*--------------------------- OCIRefAssign ----------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIRefAssign(/*_ OCIEnv *env, OCIError *err, CONST OCIRef *source, 
                       OCIRef **target _*/);
#else /* ANSI C */
...
/*-------------------------- OCIRefIsEqual ----------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
boolean OCIRefIsEqual(/*_ OCIEnv *env, CONST OCIRef *x, CONST OCIRef *y _*/);
#else /* ANSI C */
...
/*--------------------------- OCIRefIsNull ----------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
boolean OCIRefIsNull(/*_ OCIEnv *env, CONST OCIRef *ref _*/);
#else /* ANSI C */
...
/*-------------------------- OCIRefHexSize ----------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
ub4 OCIRefHexSize(/*_ OCIEnv *env, CONST OCIRef *ref _*/);
#else /* ANSI C */
...
/*-------------------------- OCIRefFromHex ---------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIRefFromHex(/*_ OCIEnv *env, OCIError *err, CONST OCISvcCtx *svc, 
                        CONST oratext *hex, ub4 length, OCIRef **ref _*/);
#else /* ANSI C */
...
/*--------------------------- OCIRefToHex -----------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIRefToHex(/*_ OCIEnv *env, OCIError *err, CONST OCIRef *ref, 
                      oratext *hex, ub4 *hex_length _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICollSize(/*_ OCIEnv *env, OCIError *err, CONST OCIColl *coll, 
                      sb4 *size _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sb4 OCICollMax(/*_ OCIEnv *env, CONST OCIColl *coll _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICollGetElem(/*_ OCIEnv *env, OCIError *err, CONST OCIColl *coll, 
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICollAssignElem(/*_ OCIEnv *env, OCIError *err, sb4 index, 
                            CONST dvoid *elem, 
                            CONST dvoid *elemind, OCIColl *coll _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICollAssign(/*_ OCIEnv *env, OCIError *err, CONST OCIColl *rhs, 
                        OCIColl *lhs _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICollAppend(/*_ OCIEnv *env, OCIError *err, CONST dvoid *elem, 
                        CONST dvoid *elemind, OCIColl *coll _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICollTrim(/*_ OCIEnv *env, OCIError *err, sb4 trim_num, 
                      OCIColl *coll _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICollIsLocator(/*_ OCIEnv *env, OCIError *err, CONST OCIColl *coll,
                       boolean *result _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIIterCreate(/*_ OCIEnv *env, OCIError *err, CONST OCIColl *coll, 
                        OCIIter **itr _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIIterDelete(/*_ OCIEnv *env, OCIError *err, OCIIter **itr _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIIterInit(/*_ OCIEnv *env, OCIError *err, CONST OCIColl *coll, 
                      OCIIter *itr _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIIterGetCurrent(/*_ OCIEnv *env, OCIError *err, CONST OCIIter *itr, 
                            dvoid **elem, dvoid **elemind _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIIterNext(/*_ OCIEnv *env, OCIError *err, OCIIter *itr, 
                      dvoid **elem, dvoid **elemind, boolean *eoc _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIIterPrev(/*_ OCIEnv *env, OCIError *err, OCIIter *itr, 
                      dvoid **elem, dvoid **elemind, boolean *boc _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITableSize(/*_ OCIEnv *env, OCIError *err, CONST OCITable *tbl, 
                       sb4 *size _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITableExists(/*_ OCIEnv *env, OCIError *err, CONST OCITable *tbl,
                             sb4 index, boolean *exists _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITableDelete(/*_ OCIEnv *env, OCIError *err, sb4 index, 
                      OCITable *tbl _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITableFirst(/*_ OCIEnv *env, OCIError *err, CONST OCITable *tbl, 
                        sb4 *index  _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITableLast(/*_ OCIEnv *env, OCIError *err, CONST OCITable *tbl, 
                       sb4 *index  _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITableNext(/*_ OCIEnv *env, OCIError *err, sb4 index, 
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITablePrev(/*_ OCIEnv *env, OCIError *err, sb4 index, 
