/*
 * $Header: ocidef.h 08-feb-2001.23:06:03 bpalaval Exp $ ocidef.h 
 */
...
#define OTYACL 195      /* Last used number in octdef.h is 191 */
...
sword ocilog( /*_ ldadef *lda, struct hstdef *hst, oratext *uid, sword uidl, 
                  ...
                  ub4 mode _*/);
sword ocilon( /*_ ldadef *lda, oratext *uid, word uidl, oratext *psw, word pswl,
                  word audit _*/);
...
sword ocibin( /*_ struct csrdef *cursor, oratext *sqlvar, word sqlvl, ub1 *progv,
	   word progvl, word ftype, word scale, oratext *fmt, word fmtl,
	   word fmtt _*/ );
sword  ocibrv( /*_ struct csrdef *cursor, oratext *sqlvar, word sqlvl, ub1 *progv,
  	         word progvl, word ftype, word scale, b2 *indp, oratext *fmt,
		 word fmtl, word fmtt _*/ );
sword  ocibra( /*_ struct csrdef *cursor, oratext *sqlvar, word sqlvl, ub1 *progv,
  	         word progvl, word ftype, word scale, b2 *indp, ub2 *aln,
                 ub2 *rcp, ub4 mal, ub4 *cal, oratext *fmt,
		 word fmtl, word fmtt _*/ );
sword  ocibndps( /*_ struct csrdef *cursor, ub1 opcode, oratext *sqlvar, sb4 sqlvl, 
		   ub1 *progv, sb4 progvl, word ftype, word scale, b2 *indp, 
		   ub2 *aln, ub2 *rcp, 
		   sb4 pv_skip, sb4 ind_skip, sb4 len_skip, sb4 rc_skip,
		   ub4 mal, ub4 *cal, oratext *fmt, sb4 fmtl, word fmtt _*/ );
