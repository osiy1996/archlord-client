...
typedef hash_map<INT32, LONG>::iterator		ItemFilterIter;
typedef hash_map<INT32, LONG>				ItemFilterMap;
...
class AgpmLog : public ApModule
	...
	public:
		...
		BOOL	WriteLogInOut(CHAR* szAccountID, const CHAR* szGameID, INT32 iServerID, UINT32 iloginTime,
							  UINT32 ilogoutTime, CHAR* szCharID, UINT32 iCharTID, UINT32 iLevel,CHAR* szIP);
		//	Filter check
