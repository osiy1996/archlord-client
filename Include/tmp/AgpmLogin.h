...
const enum eAGPMLOGIN_OPERATION
	...
	AGPMLOGIN_COUPON_INFO,
	AGPMLOGIN_CREATE_CHARACTER,	// 캐릭터 생성
...
typedef enum
{
	...
	AGPMLOGIN_RESULT_NOT_BETAKEY,
	AGPMLOGIN_RESULT_CHECK_CREATE_JUMPING_CHARACTER_SUCCESS,
	AGPMLOGIN_RESULT_CHECK_CREATE_JUMPING_CHARACTER_FAIL,

	AGPMLOGIN_RESULT_REAL_NAME_AUTH_FAIL,			// 실명인증에 실패한경우 중국만 쓰임
	AGPMLOGIN_RESULT_MAX
} AgpdLoginResult;
