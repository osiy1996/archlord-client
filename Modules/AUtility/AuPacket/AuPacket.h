...
#include <AuPacket/AuType.h>
#include <AuPacket/AuCircularBuffer.h>
#include <AuPacket/AuMiniLZO.h>
...
public:
	...
	static void SetFrameTick(UINT32 ulFrameTick);
	static UINT32 GetLastProcessedFrameTick();
};
