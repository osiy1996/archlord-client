...
#include "AuCrypt.h"
#include <AuCryptAlgorithm/AuCryptAlgorithmBase.h>
#include <vector>
...
#else
	void	SetPublicAlgorithm(eAuCryptAlgorithm eAlgorithm);
#endif
...
#else
	BOOL	InitializeActorPrivateAtDynCode( BYTE* pKey, INT32 lKeySize);
#ifdef _USE_GPK_
	BOOL	InitializeActorPrivateAtDynCode(AuCryptActor& csCryptActor);
	void	InitializeDynCodeCTX(AuCryptCell& csKeyInfo);
#endif // _USE_GPK_
#endif
