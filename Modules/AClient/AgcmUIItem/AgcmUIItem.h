...
#include <AgcmUIItem/AgcdUIItem.h>
#include <AgcmUIItem/AgcdUIItemTooltip.h>
...
typedef enum	_AgcmUIItem_Display_ID {
	...
	AGCMUI_ITEM_DISPLAY_ID_PT_SELF_CC,
	AGCMUI_ITEM_DISPLAY_ID_PT_PEER_CC,
...
class AgcmUIItem : public ApModule
{
	...
	class AgcmItemConvert		*m_pcsAgcmItemConvert;
	...
	class AgcmPrivateTrade		*m_pcsAgcmPrivateTrade;
	class AgpmEventNPCTrade		*m_pcsAgpmEventNPCTrade;
	class AgcmEventNPCTrade		*m_pcsAgcmEventNPCTrade;
	class AgcmUIControl			*m_pcsAgcmUIControl;
	class AgcmUIManager2		*m_pcsAgcmUIManager2;
	class AgcmUIMain			*m_pcsAgcmUIMain;
	class AgcmUICharacter		*m_pcsAgcmUICharacter;
	class AgcmUIAuction			*m_pcsAgcmUIAuction;
	class AgcmChatting2			*m_pcsAgcmChatting2;
	class AgcmUISplitItem		*m_pcsAgcmUISplitItem;
	class AgpmBillInfo			*m_pcsAgpmBillInfo;
	class AgpmCombat			*m_pcsAgpmCombat;
	...
	AgcdUIUserData		*m_privateTradeSelfCCUD;
	AgcdUIUserData		*m_privateTradePeerCCUD;
	...
	INT32				m_privateTradeSelfCC;
	INT32				m_privateTradePeerCC;
	...
	AgpdGrid			m_csItemLockGrid;
	AgcdUIUserData *	m_pcsItemLockGridUD;
...
public:
	...
	static BOOL CBPrivateTradeUpdateCC( PVOID pClass, PVOID pData1, PVOID pData2, PVOID pData3, PVOID pData4, PVOID pData5, ApBase *pcsTarget, AgcdUIControl *pcsSourceControl );
	//거래를 하겠다~ 라는 신호를 보낸다.
	...
	static BOOL CBPrivateTradeUpdateSelfCC(PVOID pData, PVOID pClass, PVOID pCustData );
	static BOOL CBPrivateTradeUpdatePeerCC(PVOID pData, PVOID pClass, PVOID pCustData );
	...
	static BOOL	CBItemLockMoveItem(
		PVOID			pClass, 
		PVOID			pData1, 
		PVOID			pData2, 
		PVOID			pData3, 
	...
	static BOOL CBDisplayPrivateTradeSelfCC(PVOID pClass, PVOID pData, AgcdUIDataType eType, INT32 lID, CHAR *szDisplay, INT32 *plValue);
	static BOOL CBDisplayPrivateTradePeerCC(PVOID pClass, PVOID pData, AgcdUIDataType eType, INT32 lID, CHAR *szDisplay, INT32 *plValue);
