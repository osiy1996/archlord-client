...
#if (defined(__MWERKS__) && (defined (__R5900__) || defined (macintosh)) )
#define RsSprintf sprintf
#endif /* (defined(__MWERKS__) && (defined (__R5900__) || defined (macintosh)) ) */
...
enum RsEvent
{
    ...
    rsLEFTBUTTONDOWN		,
	rsLEFTBUTTONDBLCLK		,	// 마고자 추가함.
    rsLEFTBUTTONUP			,
    rsMOUSEMOVE				,
    rsMOUSEWHEELMOVE		,
    rsRIGHTBUTTONDOWN		,
	rsRIGHTBUTTONDBLCLK		,	// 마고자 추가함.
    rsRIGHTBUTTONUP			,
    rsMIDDLEBUTTONDOWN		,
	rsMIDDLEBUTTONDBLCLK	,	// 마고자 추가함.
    rsMIDDLEBUTTONUP		,
	...
	rsCHAR					,
	rsIMECOMPOSING			,
	rsIMEStartComposition	,
	rsIMEEndComposition		,

	rsIMEUpdateIndicator	,
	rsIMEShowCandidate		,
	rsIMEHideCandidate		,
	rsIMEShowReadingWindow	,
	rsIMEHideReadingWindow	,
...
extern UINT				AppWindowEventHandler	(HWND window, UINT message, WPARAM wParam, LPARAM lParam );
...
extern RwBool                   
RsRwInitialize(void *param, RwUInt32 numLevels = 1);
//@} Jaewon
