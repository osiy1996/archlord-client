...
#include <AgcmUILogin/AgcuUIControlCamera.h>
#include <AgcmUILogin/AgcuUIControlCharacter.h>
#include <AgcmUILogin/AgcuUIControlPostFX.h>
#include <AgcmUILogin/AgcuUILoadingWindow.h>
#include <AgcmUILogin/AgcmUICharacterCreate.h>
#include <AgcmUILogin/AgcmUIServerSelect.h>
#include <AgcmUILogin/AgcmUILoginSelect.h>
#include <AgcmUILogin/AgcmUIAccountCheck.h>
...
public :
	...
	class AgcmLogin*				m_pcmLogin;
	class AgcmUIManager2*			m_pcsAgcmUIManager2;

	INT32			m_iBackUpDrawRange;					// 렌더링 범위값 저장용
	class ApWorldSector*	m_pPrevSector;						// Login중에 camera위치에 따라 섹터 위치 저장
