...
void AgcmShadow::ShadowDraw(ShadowInfo*	pShadowInfo, RwRaster* pRas)
{
	...
	float* pHeightList = (float*) AcuFrameMemory::Alloc( nHightSize );
	...
	RwIm3DVertex* pIm3DVertexList = (RwIm3DVertex*)AcuFrameMemory::AllocAppend(nVertexSize);
	...
	AcuFrameMemory::Dealloc(pHeightList);
}
