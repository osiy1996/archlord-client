...
#include <AgcmEventEffect/AgcdEventEffect.h>
#include <AgcmEventEffect/AgcuEventEffect.h>
#include <AgcmEffectDataAdmin/AgcaEffectData.h>
...
struct AgcdItem;
class AgpdFactor;
enum AgpdCharacterSocialType;
enum AgpdCharacterActionResultType;
...
public:
	...
	class AgpmTimer*			m_pcsAgpmTimer;
	...
	class AgcmEventNature*		m_pcsEventNature;
...
protected:
	...
	BOOL								m_bDisplayLensNormalDmg;
	BOOL								m_bDisplayLensSkillDmg;
	BOOL								m_bDisplayLensSkillEff;
...
public:
	...
	void DisplayLensNormalDamage(BOOL bValue);
	void DisplayLensSkillDamage(BOOL bValue);
	void DisplayLensSkillEffect(BOOL bValue);
