...
:	m_csEffectWindow( this ), m_csEffectBGMWindow( this ), m_csEffectGuildBattleWindow1( this ),
	...
	m_nEventServerSelectMouseOverSound(0), m_nEventDeadSound(0), m_nEventCriticalSound(0), m_nEventBlockSound(0), m_nEventMissSound(0)
{
...
CHAR* AgcmUIManager2::GetUIMessage(const char * szMessageID)
{
	if (!szMessageID || !szMessageID[0])
		return NULL;
