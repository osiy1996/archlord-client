...
void	AgcmUIGuildBattleOffer::SetString()
{
	...
	strcpy( m_szBattleTypeArray[eGuildBattlePointMatch], szMessage ? szMessage : "GuildBattleMode_Point" );

	szMessage = m_pcsAgcmUIManager2->GetUIMessage( "GuildBattleMode_KnockoutPoint" );
	strcpy( m_szBattleTypeArray[eGuildBattlePKMatch], szMessage ? szMessage : "GuildBattleMode_KnockoutPoint" );

	szMessage = m_pcsAgcmUIManager2->GetUIMessage( "GuildBattleMode_ChiefDeath" );
	strcpy( m_szBattleTypeArray[eGuildBattleDeadMatch], szMessage ? szMessage : "GuildBattleMode_ChiefDeath" );

	szMessage = m_pcsAgcmUIManager2->GetUIMessage( "GuildBattleMode_TotalSurvival" );
	strcpy( m_szBattleTypeArray[eGuildBattleTotalSurvive], szMessage ? szMessage : "GuildBattleMode_TotalSurvival" );

	szMessage = m_pcsAgcmUIManager2->GetUIMessage( "GuildBattleMode_PrivateSurvival" );
	strcpy( m_szBattleTypeArray[eGuildBattlePrivateSurvive], szMessage ? szMessage : "GuildBattleMode_PrivateSurvival" );
