	...
	case AGCMUI_ITEMCONVERT_TYPE_PHYSICAL:
		{
			...
			if (bResult)
			{
				...
				pThis->m_ulNextRequestConvertTime = pThis->GetClockCount() + 300;
			}
...
BOOL AgcmUIEventItemConvert::PlayEffectSuccess(BOOL bThrowEvent)
{
	...
	//m_pcsAgcmUIManager2->m_csEffectWindow.SetEffectFade(
	//	AGCMUI_ITEMCONVERT_FADE_COLOR, 
	//	AGCMUI_ITEMCONVERT_FADEIN_DURATION, 
	//	AGCMUI_ITEMCONVERT_FADEOUT_DURATION);
	m_pcsAgcmUIManager2->m_csEffectWindow.SetEffectImage(
		"Success", 
		AGCMUI_ITEMCONVERT_MSG_COLOR, 
		AGCMUI_ITEMCONVERT_MSG_INIT_SCALE, 
		AGCMUI_ITEMCONVERT_MSG_FADEIN_DURATION, 
		AGCMUI_ITEMCONVERT_MSG_SCALING_DURATION, 
		AGCMUI_ITEMCONVERT_MSG_FIXED_DURATION, 
		AGCMUI_ITEMCONVERT_SUCCESS_MARGIN_BOTTOM, 
		AGCMUI_ITEMCONVERT_SUCCESS_MARGIN_RIGHT);
	if (bThrowEvent) {
		m_lEventToThrow = m_lEventUpdateConvertInfo;
		m_ulTimeToThrowEvent = AGCMUI_ITEMCONVERT_MSG_FADEIN_DURATION + 
			AGCMUI_ITEMCONVERT_MSG_SCALING_DURATION + 
			AGCMUI_ITEMCONVERT_MSG_FIXED_DURATION;
	}
	return TRUE;
...
BOOL AgcmUIEventItemConvert::PlayEffectFailed(BOOL bThrowEvent)
{
	...
	m_pcsAgcmUIManager2->m_csEffectWindow.SetEffectImage(
		...
		AGCMUI_ITEMCONVERT_MSG_SCALING_DURATION, 
		AGCMUI_ITEMCONVERT_MSG_FIXED_DURATION, 
		AGCMUI_ITEMCONVERT_FAILED_MARGIN_BOTTOM, 
		AGCMUI_ITEMCONVERT_FAILED_MARGIN_RIGHT);
	if (bThrowEvent) {
		m_lEventToThrow = m_lEventUpdateConvertInfo;
		m_ulTimeToThrowEvent = AGCMUI_ITEMCONVERT_MSG_FADEIN_DURATION + 
			AGCMUI_ITEMCONVERT_MSG_SCALING_DURATION + 
