...
#include <AgcmItem/AgcdItem.h>
#include <AgcmItem/AgcaItemClump.h>
#include <AuRandomNumberGenerator/AuRandomNumber.h>
#include <AcuObject/AcuObject.h>
#include <AgcmItem/AgcmItemEvolutionTable.h>
#include <AgcmItem/AgcmItemEffectFinder.h>
#include <AgcmItem/AgcdItemDrop.h>
...
{
	typedef std::hash_map<UINT32, AgcdItemDropCategoryId> ItemDropCategoryMap;
...
private:
	...
	UINT32				m_ulItemDropColor[AGCD_ITEM_DROP_CATEGORYID_COUNT];
	ItemDropCategoryMap	m_hmapItemDropCategory;
...
public:
	...
	RpAtomic*				AttachNodeIndex(RpClump *pstBaseClump, RpHAnimHierarchy *pstBaseHierarchy, RpHAnimHierarchy *pstAttachHierarchy, RpAtomic *pstSrcAtomic, RwInt32 lNodeID, RwInt32 lPartID, RwMatrix *pstTransform = NULL, RpHAnimHierarchy **ppstAttachedAtomicHierarchy = NULL, enumRenderType eForedRenderType = (enumRenderType)0);	
	...
	BOOL ReadItemDropSettings();
	BOOL WriteItemDropSettings();
	void EnableItemDropSettings(BOOL bEnabled);
	BOOL IsItemDropSettingsEnabled();
	void SetItemDropColor(AgcdItemDropCategoryId eCategory, UINT32 ulColor);
	UINT32 GetItemDropColor(AgcdItemDropCategoryId eCategory);
	UINT32 GetItemDropColor(UINT32 ulItemTemplateID);
