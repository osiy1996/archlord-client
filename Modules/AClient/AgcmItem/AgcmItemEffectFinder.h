...
private :
	...
	UINT32					m_ulTargetCount;
	AgcdItemEffectTarget *	m_pstTargets;

public :
	AgcmItemEffectFinder();
	~AgcmItemEffectFinder();

	int GetCharEffectID(int nItemExtraType, int nRaceType, int nClassType);
	BOOL ReadFile();
