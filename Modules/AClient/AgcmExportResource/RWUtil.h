...
typedef struct RwUtilAtomicIntersectParams			RwUtilAtomicIntersectParams;
typedef struct RwUtilAtomicCompareVerticesParams	RwUtilAtomicCompareVerticesParams;
...
public:
	...
	RwUtilClumpFindAtomicIndexParams()
	{
		m_lAtomicIndex	= -1;
		m_lCBCount		= 0;
...
public:
	...
	RwUtilClumpGetAtomicParams()
	{
		for (INT32 lCount = 0; lCount < RWUTIL_GET_ATOMIC_MAX; ++lCount)
			m_pastAtomic[lCount]	= NULL;
