...
BOOL AgcmCashMall::SendPacketBuyProduct(INT32 lProductID, INT32 lType)
{
	INT16	nPacketLength	= 0;
	PVOID	pvPacket		= m_pcsAgpmCashMall->MakePacketBuyProduct(lProductID, m_pcsAgcmCharacter->GetSelfCID(), &nPacketLength, lType);
...
{
	INT16	nPacketLength	= 0;
	PVOID	pvPacket		= m_pcsAgpmCashMall->MakePacketBuyProduct(lProductID, m_pcsAgcmCharacter->GetSelfCID(), &nPacketLength, 0);
