...
#include <AgcmUICharacter/AgcdUICharacter.h>
#include <AgcmUICharacter/CUiCharacterProperty.h>
...
protected:
	...
	class AgpmProduct		*m_pcsAgpmProduct;
	...
	class AgcmBattleGround	*m_pcsAgcmBattleGround;
