...
#include <ApBase/ApBase.h>
#include <AgpmLogin/AgpmLogin.h>
#include <AgpmWorld/AgpmWorld.h>
...
/*
// ARCHLORD Registry Key
#ifdef _AREA_GLOBAL_
	#define REGIKEY_ARCHLORD			_T("SOFTWARE\\Webzen\\Archlord")
	#define REGIKEY_LOGINSERVERIP		_T("LoginServerIP")
	#define REGIKEY_LOGINSERVERPORT		_T("LoginServerPort")
...
#ifdef _AREA_GLOBAL_
	AGCMLOGIN_MODE_LOGIN_SERVER_SELECT,			// Login Server Select
#endif
};
...
public:
	...
	BOOL	SetMakingCharacterInfo(const INT32 _lTID, const INT32 _lSelectedFace, const INT32 _lSelectedHair, const char* const _szCharacterName);
	...
	BOOL	SendCreateCharacter(TCHAR *pszAccount, TCHAR *pszWorld, INT32 lTID, TCHAR *pszCharID, INT32 lIndex, INT32 lUnion, INT32 lHairIndex, INT32 lFaceIndex, INT32 bIsJumpingCharacter);
...
public:
	...
	class AgpmResourceInfo*		m_pAgpmResourceInfo;
	...
	// Jumping Promotion용 임시변수
	INT32				m_lSelectedHair;
	INT32				m_lSelectedFace;
