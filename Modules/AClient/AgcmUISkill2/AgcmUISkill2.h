...
#include <AgpmEventSkillMaster/AgpdEventSkillMaster.h>
#include <AgcmUIControl/AcUIToolTip.h>
#include <AgcmUISkill2/AgcmUISkillDragonScion.h>
#include <AgcmUISkill2/AgcmHeroicSkill.h>
...
class AgpdItem;
class AgpdSkill;
class AgpdSkillTooltipTemplate;
struct stAgpmSkillBuffList;
class AgpdFactor;
struct ApdEvent;
...
private:
	...
	class AgcmEventSkillMaster	*m_pcsAgcmEventSkillMaster;
	...
	class AgcmUICashInven		*m_pcsAgcmUICashInven;
...
public:
	...
	INT32					GetSelectCharacterTID(VOID);
