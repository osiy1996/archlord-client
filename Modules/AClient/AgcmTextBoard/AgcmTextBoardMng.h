...
#include <AgcmTextBoard/AgcmTextBoardDef.h>
#include <AgcmTextBoard/CFlagImoticon.h>
...
public:
	...
	RwTexture*				GetTeamFlagTexture	( UINT64 uiState );
	RwTexture*				GetBestOfClassTexture(AgpdCharacter * pCharacter);
