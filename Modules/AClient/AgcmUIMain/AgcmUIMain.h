...
#include <AgcmUIMain/AgcmUIMainSystemGridTooltip.h>
...
private:
	...
	AgcdUIUserData *	m_quickBeltUD[8];
...
//	AgcdUIUserData *	m_pstSkill;
	...
	INT32				m_eventShowAdditionalQuickBelt1;
	INT32				m_eventHideAdditionalQuickBelt1;
	INT32				m_eventShowAdditionalQuickBelt2;
	INT32				m_eventHideAdditionalQuickBelt2;
	INT32				m_eventShowAdditionalQuickBelt3;
	INT32				m_eventHideAdditionalQuickBelt3;
	INT32				m_eventUpdateHpMpBarPosition;
...
public:
	AgpdGrid			m_quickBeltGrid[8];
//	AgpdGrid			m_astVQuickBeltGrid[2];
//	AgpdGrid			m_stSkillGrid;
	INT32				m_quickBeltCurrentLayer;
...
public:
	...
	static BOOL CBShowAdditionalQuickBelt(
		PVOID			pClass, 
		PVOID			pData1, 
		PVOID			pData2, 
		PVOID			pData3, 
	...
	static BOOL CBHideAdditionalQuickBelt(
		PVOID			pClass, 
		PVOID			pData1, 
		PVOID			pData2, 
		PVOID			pData3, 
	...
	static BOOL CBUpdateHpMpBarPosition(
		PVOID			pClass, 
		PVOID			pData1, 
		PVOID			pData2, 
		PVOID			pData3, 
...
//	static BOOL		CBRemoveItem(PVOID pData, PVOID pClass, PVOID pCustData);
	...
	BOOL			UseGridItem(AgpdGridItem *pcsGridItem);
	BOOL			RefreshQBeltGridItemStackCount();
