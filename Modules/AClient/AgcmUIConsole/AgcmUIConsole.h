...
#include <AuScriptEngine/AuAngelScriptEngine.h>
#include <AuConsole/AuConsole.h>
...
private:
	...
	AgcConsole console_;
	class AgcmUIManager2 *pAgcmUIManager2_;
	class AgpmScript *pAgpmScript_;
	class AgcmCharacter *pAgcmCharacter_;
