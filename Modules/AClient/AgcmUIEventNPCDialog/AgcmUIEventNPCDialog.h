...
#include <time.h>
#include <sys/timeb.h>
#include <AgcmUIEventNPCDialog/CNpcTextManager.h>
...
public:
	...
	void Reset()
	{
		...
		m_eFunctionType = (ApdEventFunction)0;
		m_bExit = false;
	}
};
