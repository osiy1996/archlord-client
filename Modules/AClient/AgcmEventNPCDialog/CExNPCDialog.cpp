...
#ifdef _AREA_GLOBAL_
	m_EditTitleBar.MoveWindow( 14, 4, 160, 16 );
#elif defined(_AREA_CHINA_)
	m_EditTitleBar.MoveWindow( 28, 3, 116, 16 );
#else
...
#ifdef _AREA_GLOBAL_
		pBtn->AddButtonImage( "Common_Button_Large_CropEmptyArea_A.png", ACUIBUTTON_MODE_NORMAL );
		pBtn->AddButtonImage( "Common_Button_Large_CropEmptyArea_B.png", ACUIBUTTON_MODE_ONMOUSE );
		pBtn->AddButtonImage( "Common_Button_Large_CropEmptyArea_C.png", ACUIBUTTON_MODE_CLICK );
		pBtn->AddButtonImage( "Common_Button_Large_CropEmptyArea_D.png", ACUIBUTTON_MODE_DISABLE );
