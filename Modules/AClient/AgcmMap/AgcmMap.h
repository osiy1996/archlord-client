...
#include <AgcmMap/AcMaterialList.h>
#include <AgcmMap/AcMapLoader.h>
#include <AgcModule/MagImAtomic.h>
...
struct tag_IntersectionSectors;
typedef struct tag_IntersectionSectors IntersectionSectors;
