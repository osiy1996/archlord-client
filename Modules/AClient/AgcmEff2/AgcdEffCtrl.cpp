#include <AgcmEff2/AgcdEffCtrl.h>
#include <AgcmEff2/AgcdEffGlobal.h>
#include <AgcmEff2/AgcdEffBoard.h>
#include <AgcmEff2/AgcdEffLight.h>
#include <AgcmEff2/AgcdEffMFrm.h>
#include <AgcmEff2/AgcdEffObj.h>
#include <AgcmEff2/AgcdEffSound.h>
#include <AgcmEff2/AgcdEffTail.h>
#include <AgcmEff2/AgcdEffParticleSystem.h>
...
#include <AgcmEff2/AgcuEffTable.h>
#include <AcuMath/AcuMathFunc.h>
#include <AcuMath/AcuSinTbl.h>
...
#ifdef USE_MFC
			if( AgcdEffGlobal::bGetInst().bGetShowEffBase() && pEntry->m_pEffCtrlBase->GetCPtrEffBase() != AgcdEffGlobal::bGetInst().bGetShowEffBase() )
			{
				++Iter;
				continue;
			}
...
RwInt32 AgcdEffCtrl_Sound::Update3DSoundPos()
{
	...
	if( m_bPlayed )
	{
		if( m_eSoundType == AgcdEffSound::EFFECT_SOUND_3DSOUND )
		{
			...
			{
				if( AgcdEffGlobal::bGetInst().bGetPtrAgcmSound()->IsIn3DSoundRange( &m_pEffCtrl_Set->GetPtrSphere()->center ) )
				{
					return 
					lpEffBase_Sound->bPosUpdateFor3DSound( 
					m_dwSoundIndex
...
void AgcdEffCtrl_PostFX::SetState( E_EFFCTRL_STATE eState )
{
	if( eState == E_EFFCTRL_STATE_END && this == PROCESSEDPOSTFX )
	{
		...
		if(OLDFXSTATE)
		{
			//pAgcmPostFX->CreateFX(PIPEBU, 1023);
		}
		else
		{
			pAgcmPostFX->PostFX_OFF();
		}
	}
...
RwInt32 AgcdEffCtrl_PostFX::Update(RwUInt32 dwAccumulateTime)
{
	...
	if( !PROCESSEDPOSTFX )
	{
		...
		pAgcmPostFX->CreateFX( "Auto" , E_PIPELINE_CLAMPINGCIRCLE );
		pAgcmPostFX->PostFX_ON();
		BONFX = true;
