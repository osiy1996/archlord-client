...
BOOL AgpmItem::AddItemToBank(INT32 lCID, AgpdItem *pcsAgpdItem, INT32 lLayer, INT32 lRow, INT32 lColumn, BOOL bStackMerge, BOOL bRecieveFromServer)
{
	return AddItemToBank(m_pagpmCharacter->GetCharacter(lCID), pcsAgpdItem, lLayer, lRow, lColumn, bStackMerge, bRecieveFromServer);
}

BOOL AgpmItem::AddItemToBank(AgpdCharacter *pcsCharacter, AgpdItem *pcsAgpdItem, INT32 lLayer, INT32 lRow, INT32 lColumn, BOOL bStackMerge, BOOL bRecieveFromServer)
{
