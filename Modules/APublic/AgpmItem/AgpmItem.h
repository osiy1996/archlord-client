...
#include <AgpmItem/AgpdItemImportData.h>
...
typedef enum AgpmItemPacketOperation
{
	...
	AGPMITEM_PACKET_OPERATION_UPDATE_STATUS_FLAG = 0x21,
...
public:
	...
	class AgpmBillInfo*			m_pagpmBillInfo;
	class AgpmSystemMessage*	m_pagpmSystemMessage;
...
//	BOOL                    PreUpdateItem(AgpdItem *pItem, AgpdItemStatus eCurrentStatus);
	...
	BOOL					CheckUseItem(AgpdCharacter *pcsCharacter, AgpdItem *pcsItem, BOOL bExceptLevel = FALSE);
...
//	AgpdGrid				*GetUnseenInventory( AgpdCharacter *pcsAgpdCharacter );
	...
	*/
	...
	void					SetNPCPrice(AgpdItem *pcsItem, float fPrice);
	...
	*/
	...
	PVOID MakePacketUpdateStatusFlag(
		AgpdItem *	pcsItem, 
