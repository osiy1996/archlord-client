...
PVOID
AgpmOptimizedPacket2::MakePacketCancelAction(AgpdCharacter * pcsCharacter, INT16 * pnPacketLength)
{
	UINT8 cMoveFlag = AGPMCHARACTER_MOVE_FLAG_CANCEL_ACTION;
	PVOID pvPacket;

	if (!pcsCharacter || !pnPacketLength)
		return NULL;
	pvPacket = m_csPacketCharMove.MakePacket(TRUE, pnPacketLength, 
		AGPMOPTIMIZEDCHARMOVE_PACKET_TYPE,
		&pcsCharacter->m_lID,
		NULL,
		NULL,
		NULL,
