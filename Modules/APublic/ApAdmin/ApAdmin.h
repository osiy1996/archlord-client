...
private:
	//@{ Jaewon 20041118
	// hash_map is not a part of the standard library according to C++ standard.
	typedef /*stdext::*/hash_map<INT_PTR, INT32> HashMap_INT32;
	typedef /*stdext::*/hash_map<std::string, INT32> HashMap_string;
	//@} Jaewon
