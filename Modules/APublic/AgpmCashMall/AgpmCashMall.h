...
private:
	...
	// 아래 EncodeString 배열 10개로 늘렸다. 2007.08.16. steeple
	ApString<4096>		m_strMallEncodeString;
	ApString<16384>		m_strProductListEncodeString[AGPMCASHMALL_MAX_TAB_COUNT];		// 2007.03.28. laki. 짱깨는 4096넘었다. -_-; 패킷사이즈제한이 있으니 8192에 만족하도록 하자. 쫌...
