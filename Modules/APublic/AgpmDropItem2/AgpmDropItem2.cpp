...
AgpdDropItemADCharTemplate * AgpmDropItem2::GetCharacterTemplateData(AgpdCharacterTemplate * pcsTemplate)
{
	return (AgpdDropItemADCharTemplate *) m_pcsAgpmCharacter->GetAttachedModuleData(m_lADIndexCharacterTemplate, pcsTemplate);
}

AgpdDropItemADItemTemplate * AgpmDropItem2::GetItemTemplateData(AgpdItemTemplate *pcsTemplate)
{
