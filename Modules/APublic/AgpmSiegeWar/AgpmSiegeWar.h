...
#include <AgpmSiegeWar/AgpdSiegeWar.h>
...
const int	AGPMSIEGEWAR_GUILD_CREATE_TIME_REQUIREMENT		= 60 * 60 * 24 * 3;		// 60초 * 60분 * 24시간 * 14일
