...
#include <AgpmCharacter/AgpaCharacter.h>
#include <AgpmCharacter/AgpaCharacterTemplate.h>
#include <AuExcelTxtLib/AuExcelTxtLib.h>
#include <AgpmCharacter/AgpdCharacterImportData.h>
...
#define AGPMCHARACTER_MOVE_FLAG_CANCEL_ACTION		0x80
...
typedef enum AgpmCharacterPacketOperation {
	...
	AGPMCHAR_PACKET_OPERATION_UPDATE_GAMEPLAY_OPTION = 80,
...
typedef enum AgpmCharacterCallbackPoint			// Callback ID in Character Module 
{
	...
	AGPMCHAR_CB_ID_CHECK_MOVEMENT_LOCK,
...
private:
	...
	ApmMap*					m_pcsApmMap;
	class AgpmConfig*		m_pcsAgpmConfig;
...
public:
	...
	BOOL	SetCallBackCheckMovementLock(ApModuleDefaultCallBack pfCallback, PVOID pClass);
	...
	void SetMoveLockFrameTick(UINT32 ulFrameTick);
	UINT32 GetMoveLockFrameTick();
};
