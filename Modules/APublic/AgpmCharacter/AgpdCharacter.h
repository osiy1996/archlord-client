...
const UINT64 AGPDCHAR_SPECIAL_STATUS_FLAG_BLUE					= 0x0000800000000000;
const UINT64 AGPDCHAR_SPECIAL_STATUS_FLAG_RED					= 0x0001000000000000;
const UINT64 AGPDCHAR_SPECIAL_STATUS_BEST_OF_CLASS				= 0x0002000000000000;
...
typedef enum AgpdCharacterSocialType
{
...
//	AuBLOCKING					m_astWorldBlockInfo[AGPDCHARACTER_MAX_BLOCK_INFO];
	...
	class AgpdTitle*			m_csTitle;
	class AgpdTitleQuest*		m_csTitleQuest;
