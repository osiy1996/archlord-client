...
#define AGSMSERVER_MAX_REGION_NAME			32
...
#define AGSMSERVER_EXTRA_KEY_START_CHARISMA				_T("StartCharisma")		

#ifndef _AREA_CHINA_
#define	AGSMSERVER_EXTRA_KEY_JUMPING_START_LEVEL		_T("JumpingStartLevel")		
#define	AGSMSERVER_EXTRA_KEY_JUMPING_START_GHELD		_T("JumpingStartGheld")
#define AGSMSERVER_EXTRA_KEY_JUMPING_START_CHARISMA		_T("JumpingStartCharisma")
#endif
...
class AgsdServer2
	...
	public:
		...
		CHAR			m_szServerRegion[AGSMSERVER_MAX_REGION_NAME+1];
		...
		INT32			m_lStartCharisma;

#ifndef _AREA_CHINA_
		INT32			m_lJumpingStartLevel;
		INT64			m_llJumpingStartGheld;
		INT32			m_lJumpingStartCharisma;
#endif
