...
#ifndef _AREA_CHINA_
	AGSMLOGIN_OPERATION_CREATE_JUMPING_CHARACTER_CHECK,
#endif
	};
...
class AgsmLoginQueueInfo : public ApMemory<AgsmLoginQueueInfo, 10000>
...
#ifndef _AREA_CHINA_
		INT32			m_lIsJumpingCharacter;		// 0 is FALSE , 1 is TRUE
#endif
...
#if defined(_AREA_KOREA_) || defined(_AREA_JAPAN_) || defined(_AREA_CHINA_)
		TCHAR			m_szHanAuthString[2048+1];
#else if _AREA_GLOBAL_
		TCHAR			m_szGBAuthString[2048+1]; //global service authstring
	...
	public:
		...
		void Init()
			...
			m_ulGameServerNID = 0;
#ifndef _AREA_CHINA_
			m_lIsJumpingCharacter = 0;	// 0 is FALSE , 1 is TRUE
#endif
