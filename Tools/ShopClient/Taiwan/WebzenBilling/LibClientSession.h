...
protected:
	...
	void OnInquireCash(char *AccountID, double Cash, long ResultCode);
	void OnBuyProduct(char *AccountID, INT64 ItemNo, INT64 OrderNo, int OrderNumber, WCHAR *RetMessage, long ResultCode);
