...
#define PT_PARENT_ITEM_NAME_MATERIAL			"[ MATERIAL ]"
//@{ 2006/05/29 burumal
...
#define PT_ITEM_NAME_MATERIAL_EDIT				" Material Edit "
#define PT_ITEM_NAME_MATERIAL_DELETE			" Material Delete "
...
typedef enum ePropertyTreeItemData
{
	...
	E_PT_ITEM_DATA_MATERIAL_EDIT,
	E_PT_ITEM_DATA_MATERIAL_DELETE,
};
...
protected:
	...
	HTREEITEM		m_hMaterialEdit;
	HTREEITEM		m_hMaterialDelete;
