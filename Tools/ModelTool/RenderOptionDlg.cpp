...
void CRenderOptionDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_SHOW_RWSINFO,			m_CurrentRenderOption.m_bRWSInfo);
	...
	DDX_Check(pDX, IDC_VSYNC_ON	,				m_CurrentRenderOption.m_bvSyncOn);
}
...
void CRenderOptionDlg::OnOK() 
{
	...
	m_pcsDestRenderOption->m_bvSyncOn				= m_CurrentRenderOption.m_bvSyncOn;
	m_pcsDestRenderOption->m_bRWSInfo				= m_CurrentRenderOption.m_bRWSInfo;
