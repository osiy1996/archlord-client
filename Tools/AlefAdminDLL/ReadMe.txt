========================================================================
    MFC 라이브러리 : AlefAdminDLL 프로젝트 개요
========================================================================


응용 프로그램 마법사에서 이 AlefAdminDLL DLL을 만들었습니다.
 이 DLL은 MFC의 기본적인 사용법을 보여 줄 뿐아니라
사용자가 DLL을 만드는 데 있어 출발점이 될 수 있습니다.

이 파일에는 AlefAdminDLL 응용 프로그램 DLL을 구성하는 각각의 파일에
...
StdAfx.h 및 StdAfx.cpp는
    AlefAdminDLL.pch라는 이름의 PCH(미리 컴파일된 헤더) 파일과
