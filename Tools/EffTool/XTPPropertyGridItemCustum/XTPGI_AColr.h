...
class CXTPGI_ACamera
	:	public CXTPGI_Anim
{
public:
	CXTPGI_ACamera( CString strCaption , AgcdEffAnim_Camera* pEffAnimCamera );
	~CXTPGI_ACamera( VOID )	{ }

protected:
	virtual VOID OnAddChildItem( VOID );

private:
	AgcdEffAnim_Camera*			m_pAnimCamera;
};
