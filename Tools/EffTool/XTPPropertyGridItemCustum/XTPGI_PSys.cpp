...
void CXTPGI_PSys::OnAddChildItem()
{
	...
	m_pItemClumpName = (CXTPGI_FileName*)AddChildItem(new CXTPGI_FileName(_T("clump"), EFF2_FILE_NAME_MAX, m_pPSys->m_szClumpFName, m_pPSys->m_szClumpFName, AgcuEffPath::GetPath_Clump(), FILTER ) );
	...
	//flags
	(CXTPGI_FlagBool*)AddChildItem(new CXTPGI_FlagBool(&m_pPSys->m_dwBitFlags, FLAG_EFFBASEPSYS_TARGETDIR			,_T("Dir Of Target"		)));
