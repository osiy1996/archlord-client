...
protected:
	virtual void OnAddChildItem()
	{
		...
		m_pItemTex = (CXTPGI_FileName*)AddChildItem(new CXTPGI_FileName(_T("tex"), EFF2_FILE_NAME_MAX, m_pEffTex->m_szTex, m_pEffTex->m_szTex, AgcuEffPath::GetPath_Tex(), TEXFILTER ) );
		m_pItemMask = (CXTPGI_FileName*)AddChildItem(new CXTPGI_FileName(_T("mask"), EFF2_FILE_NAME_MAX, m_pEffTex->m_szMask, m_pEffTex->m_szMask, AgcuEffPath::GetPath_Tex(), TEXFILTER  ) );
	}
